...
public class AnaliseResultadoTests
{
    ...
    public void Criar_DeveCriarComSucesso_QuandoDadosValidos()
    {
        ...
        // Assert
        analiseResultado.DescricaoAnalise.Valor.ShouldBe("Análise gerada");
        analiseResultado.ComponentesIdentificados.Count.ShouldBe(1);
        analiseResultado.RiscosArquiteturais.Count.ShouldBe(1);
        analiseResultado.RecomendacoesBasicas.Count.ShouldBe(1);
    }
