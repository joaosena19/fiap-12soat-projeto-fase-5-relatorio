...
public class ApiConfigurationsTests
{
    ...
    [Fact(DisplayName = "Deve configurar Serilog sem lançar exceção")]
    [Trait("API", "SerilogConfiguration")]
    public void ConfigurarSerilog_DeveConfigurarSemExcecao_QuandoInvocado()
    {
        // Arrange
        var fixture = new ApiConfigurationTestFixture();

        // Act & Assert
        Should.NotThrow(() => SerilogConfiguration.ConfigurarSerilog(fixture.BuildConfiguration()));
    }
