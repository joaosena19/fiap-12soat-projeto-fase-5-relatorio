...
public class RelatorioControllerTests : IDisposable
{
    ...
    [Fact(DisplayName = "SolicitarRelatoriosRequestDto deve conter tipos informados")]
    [Trait("API", "SolicitarRelatoriosRequestDto")]
    public void SolicitarRelatoriosRequestDto_DeveConterTiposInformados()
    {
        // Act
        var dto = new SolicitarRelatoriosRequestDto
        {
            TiposRelatorio = new List<TipoRelatorioEnum> { TipoRelatorioEnum.Json, TipoRelatorioEnum.Pdf }
        };

        // Assert
        dto.TiposRelatorio.ShouldContain(TipoRelatorioEnum.Json);
        dto.TiposRelatorio.ShouldContain(TipoRelatorioEnum.Pdf);
